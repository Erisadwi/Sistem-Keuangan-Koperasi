    ...
    public function apiIndex(Request $request)
{
    ...
    $data = $query->orderBy('id_transaksi', 'desc')->paginate(15);

    return response()->json([
        'status' => true,
        'message' => 'Data transfer berhasil diambil',
        'data' => $data
    ]);
}
    ...
    public function apiStore(Request $request)
{
    $request->validate([
        ...
        'id_akun_tujuan' => [
            'required',
            Rule::exists('jenis_akun_transaksi', 'id_jenisAkunTransaksi')
                ->where(fn($q) => $q->where('transfer', 'Y')->where('is_kas', 1)),
        ],
    ...
    public function apiUpdate(Request $request, $id)
{
    ...
    try {
        ...
        return response()->json([
            'status' => true,
            'message' => 'Transaksi transfer berhasil diperbarui',
            'data' => $transaksi
        ]);
...
public function apiDestroy($id)
{
    ...
    try {
        ...
        return response()->json([
            'status' => true,
            'message' => 'Transaksi transfer berhasil dihapus'
        ]);
