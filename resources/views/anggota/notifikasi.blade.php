...
<head>
  ...
  @vite('resources/css/styleNotifikasiAnggota.css')
</head>
<body class="bg-gray-50 font-sans">
  ...
  <div id="actionMenu" class="action-menu" role="menu" aria-hidden="true">
    <ul>
      <li data-action="mark-read">Mark Read</li>
      <li data-action="mark-unread">Mark Unread</li>
      <li data-action="mark-important">Mark Important</li>
      <li data-action="mark-as-not-important">Mark As-Not-Important</li>
      <li data-action="add-star">Add Star</li>
      <li data-action="filter-messages-like-these">Filter Messages Like These</li>
      <li data-action="mute">Mute</li>
      <li data-action="forward-as-attachment">Forward As Attachment</li>
    </ul>
  </div>
