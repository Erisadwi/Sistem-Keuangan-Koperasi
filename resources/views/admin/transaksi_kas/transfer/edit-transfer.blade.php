...
<div class="form-container">
    <form action="{{ route('transaksi-transfer.update', $TransaksiTransfer->id_transaksi) }}" method="POST">
        ...
        <input type="datetime-local" id="tanggal_transaksi" name="tanggal_transaksi" 
                value="{{ old('tanggal_transaksi', isset($TransaksiTransfer->tanggal_transaksi) ? \Carbon\Carbon::parse($TransaksiTransfer->tanggal_transaksi)->format('Y-m-d\TH:i') : '') }}">
        ...
        <input type="text" id="keterangan" name="keterangan" value="{{ old('keterangan', $TransaksiTransfer->ket_transaksi ?? '') }}">

        <div class="form-buttons">
            <button type="submit" class="btn btn-simpan">Simpan</button>
            <a href="{{ route('transaksi-transfer.index') }}" class="btn btn-batal">Batal</a>
        </div>
